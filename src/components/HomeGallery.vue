<template>
    <ul class="home-gallery__list">
        <li v-for="item in posts" :key="item.node.path" class="home-gallery__item">
    ...
    &:nth-of-type(2) {
      ...
      .home-gallery__link {
        .home-gallery__title {
          ...
          @include screen--large {
            @include home-gallery-title(13vw !important, rotate(0deg), bottom left, left, -5px, top, -4.5vw !important);
          }        
        }

        &:hover, &:focus {
          .home-gallery__title {
            @include home-gallery-title(17rem, rotate(0deg) scale(0.7), bottom left, left, -5px, top, -6rem);
          }
        }
      }
    }
